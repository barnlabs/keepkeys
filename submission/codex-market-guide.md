...
The checksum is generated by `./scripts/package-submission` after the final
source and catalog pins are reviewed.
...
- five positive cases covering explicit native paste, private phone intake,
  metadata/status/doctor inspection, approved direct use with rotation and
  automatic-approval revocation, and confirmed removal;
