...
Never include a real API key, password, token, private key, seed phrase, customer record, credential-bearing screenshot, Keychain export, or transcript. Reproduce with a generated synthetic value.
...
4. a temporary `./scripts/doctor` Keychain round trip on macOS;
5. independent security review of the final diff.
