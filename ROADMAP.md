...
- [ ] Evaluate biometric or access-control hardening without degrading Keychain
      reliability or accessibility
- [ ] Evaluate Linux support only after a native secure-entry, secret-service,
      deletion, redaction, and end-to-end test design is complete
...
- a standalone KeepKeys application;
