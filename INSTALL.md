...
cf6e9f0fc143785a1931577bbafe0feaa33a5fd4

Claude/OMP catalog commit
9a3da3b13ab441d46c0e447eb7e31f9bfd2aad19
```
...
codex plugin marketplace add barnlabs/keepkeys \
  --ref cf6e9f0fc143785a1931577bbafe0feaa33a5fd4
...
```sh
grok plugin install \
  'barnlabs/keepkeys@cf6e9f0fc143785a1931577bbafe0feaa33a5fd4#plugins/keepkeys' \
  --trust
grok plugin list
...
claude plugin marketplace add \
  https://raw.githubusercontent.com/barnlabs/keepkeys/9a3da3b13ab441d46c0e447eb7e31f9bfd2aad19/.claude-plugin/marketplace.json
...
`cf6e9f0fc143785a1931577bbafe0feaa33a5fd4`. Start a new Claude Code session.

## Oh My Pi

```sh
omp plugin marketplace add \
  https://raw.githubusercontent.com/barnlabs/keepkeys/9a3da3b13ab441d46c0e447eb7e31f9bfd2aad19/.omp-plugin/marketplace.json
...
```powershell
git clone https://github.com/barnlabs/keepkeys.git keepkeys-0.4.0
git -C keepkeys-0.4.0 checkout --detach cf6e9f0fc143785a1931577bbafe0feaa33a5fd4
...
cd keepkeys
git checkout --detach cf6e9f0fc143785a1931577bbafe0feaa33a5fd4
./scripts/bootstrap
./scripts/check
./scripts/test
./scripts/doctor
